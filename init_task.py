...
def parser():
    ...
    parser.add_argument('--user_per_group', type=int, default=1, help='total training epochs')
...
if __name__ == '__main__':
    ...
    for i in range(0, len(portable2profile), args.user_per_group):
        user_info = portable2profile[1]
        selenium_config = {
            # "portable_path": portable2profile[0],
            "extension_list": ['metamask']
        }
        run_once(user_info, selenium_config)
        break
